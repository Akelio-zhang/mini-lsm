...
impl<T: AsRef<[u8]>> Key<T> {
    ...
    /// Backward-compatible alias from week 1 + 2. In week 3, prefer `key_len`.
...
impl Key<Vec<u8>> {
    ...
    /// Backward-compatible constructor from week 1 + 2.
    ...
    /// Backward-compatible alias from week 1 + 2.
...
impl<'a> Key<&'a [u8]> {
    ...
    /// Create a key slice from a slice and a ts. Will be removed in week 3.
