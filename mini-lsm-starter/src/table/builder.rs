...
use crate::{
    block::BlockBuilder,
    key::{KeyBytes, KeySlice, KeyVec, TS_DEFAULT},
...
impl SsTableBuilder {
    ...
    fn finish_block(&mut self) {
        ...
        let first_key = std::mem::replace(&mut self.first_key, KeyVec::new()).into_key_bytes();
        let last_key = self.last_key.clone().into_key_bytes();
    ...
    pub fn build(
        ...
        // encode block meta (includes max_ts and checksum)
